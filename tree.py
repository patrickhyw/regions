...
# root. Generated by Opus 4.6. See animal_replace_when_minimal.json.
_ANIMAL_REPLACE_PATH = Path(__file__).parent / "animal_replace_when_minimal.json"
with open(_ANIMAL_REPLACE_PATH) as _f:
    ANIMAL_REPLACE_WHEN_MINIMAL: dict[str, str | None] = json.load(_f)
